...
export class ClassificationLoader extends Emitter {
    constructor(studioHostUrl, auth) {
        super();
    ...
    async downloadDeployment(projectId, deployType) {
        return new Promise((resolve, reject) => {
            const x = new XMLHttpRequest();
    ...
    async buildDeployment(projectId, deployType) {
        if (this._auth.auth !== 'apiKey') {
...
//# sourceMappingURL=classification-loader.js.map