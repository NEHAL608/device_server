import { getAuth, getDeviceId, getFrequency, getKeyword, getSampleLength, getStudioEndpoint, storeApiKeyAndImpulseId, storeDeviceId, storeFrequency, storeKeyword, storeSampleLength } from "./settings";
...
export class DataCollectionKeywordClientViews {
    constructor() {
        ...
        this._sensors = [];
        this._findSegments = new FindSegments();
    }
    async init() {
...
//# sourceMappingURL=collection-keyword.js.map